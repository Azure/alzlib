...
func TestPolicyDefinitionVersions_Add_VersionlessFirst(t *testing.T) {
...
func TestPolicyDefinitionVersions_Add_VersionedFirst(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
	name := "Test Policy"
	version := "1.0.0"
...
func TestPolicyDefinitionVersions_Add_DuplicateSemVer(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
	version := "1.0.0"
...
func TestPolicyDefinitionVersions_Add_MixVersionedAndVersionless(t *testing.T) {
	version := "1.0.0"
...
func TestPolicyDefinitionVersions_Add_InvalidVersionString(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
	name := "Test Policy"
...
func TestPolicyDefinitionVersions_Add_NilPolicyOrProperties(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
...
func TestPolicyDefinitionVersions_Add_DifferentName(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
...
func TestPolicyDefinitionVersions_GetVersion_Versionless(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
...
func TestPolicyDefinitionVersions_GetVersion_Versioned(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
...
func TestPolicyDefinitionVersions_GetVersion_InvalidConstraint(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
	name := "PolicyVersioned"
	v1 := "1.0.0"
...
func TestPolicyDefinitionVersions_GetVersion_WildcardConstraint(t *testing.T) {
	pdvs := NewPolicyDefinitionVersions()
	name := "PolicyVersioned"
	v1 := "1.0.0"
	policy := fakePolicyDefinitionVersioned(name, v1)
